...
/** Fixed-step custom vehicle-pair collision and recovery tuning. */
export const VEHICLE_COLLISION = {
  BROADPHASE_CELL_SIZE: 128,
  FULL_PHYSICS_RADIUS: 760,
  MEDIUM_PHYSICS_RADIUS: 1180,
  MAX_BROADPHASE_PAIRS: 4096,
  MAX_CONTACTS: 512,
  MAX_CONTACTS_PER_VEHICLE: 4,
  SOLVER_ITERATIONS: 2,
  RESTITUTION_MAX: 0.42,
  FRICTION_MAX: 1.2,
  PENETRATION_SLOP: 0.65,
  POSITION_CORRECTION_PERCENT: 0.34,
  MAX_POSITION_CORRECTION: 4.5,
  MAX_SWEEP_REWIND: 14,
  PAIR_COOLDOWN_MS: 260,
  DAMAGE_COOLDOWN_MS: 420,
  DAMAGE_ENERGY_THRESHOLD: 900_000,
  DAMAGE_ENERGY_SCALE: 0.0000032,
  MIN_EVENT_IMPULSE: 8_000,
  LIGHT_IMPULSE: 42_000,
  HEAVY_IMPULSE: 165_000,
  IMPACT_RESPONSE_SECONDS: 0.22,
  IMPACT_RECOVER_SPEED: 18,
  IMPACT_SETTLE_SPEED: 3.5,
  IMPACT_SETTLE_ANGULAR_SPEED: 0.08,
  LANE_REJOIN_RATE: 1.7,
  HEADING_REJOIN_RATE: 2.4,
  PARKED_RELEASE_OFFSET: 3,
  WORLD_SAFETY_BINARY_STEPS: 6,
  TELEMETRY_SAMPLE_CAPACITY: 2048,
  COLLISION_CPU_BUDGET_MS: 2.2,
} as const;
