...
export enum EventKeys {
  ...
  // ── Housing / real estate ───────────────────────────────────────────────
  RealEstateInteractionRequested = 'housing:real-estate-interaction-requested',
  RealEstateOpened = 'housing:real-estate-opened',
  RealEstateClosed = 'housing:real-estate-closed',
  PropertyPreviewRequested = 'housing:property-preview-requested',
  PropertyPreviewStarted = 'housing:property-preview-started',
  PropertyPreviewEnded = 'housing:property-preview-ended',
  PropertyPurchaseRequested = 'housing:property-purchase-requested',
  PropertyOwnershipChanged = 'housing:property-ownership-changed',
  HomeEnterRequested = 'housing:home-enter-requested',
  HomeEnterAccepted = 'housing:home-enter-accepted',
  HomeEnterRejected = 'housing:home-enter-rejected',
  HomeExitRequested = 'housing:home-exit-requested',
  HomeExited = 'housing:home-exited',
  HomeTransitionFailed = 'housing:home-transition-failed',
  PropertyUpgradePurchaseRequested = 'housing:property-upgrade-purchase-requested',
  PropertyUpgradeChanged = 'housing:property-upgrade-changed',
  PropertyCustomizationApplied = 'housing:property-customization-applied',
  PropertyCustomizationCancelled = 'housing:property-customization-cancelled',
  PropertyCustomizationRejected = 'housing:property-customization-rejected',
  PropertyRoomUnlocked = 'housing:property-room-unlocked',
  GarageOperationRequested = 'housing:garage-operation-requested',
  GarageOperationCompleted = 'housing:garage-operation-completed',
  GarageOperationRejected = 'housing:garage-operation-rejected',
  NeighborInteractionRequested = 'housing:neighbor-interaction-requested',
  NeighborInteractionCompleted = 'housing:neighbor-interaction-completed',
  NeighborAffinityChanged = 'housing:neighbor-affinity-changed',
  HousingMissionOffered = 'housing:mission-offered',
  HousingMissionCompleted = 'housing:mission-completed',
  SafehouseUseRequested = 'housing:safehouse-use-requested',
  SafehouseUseCompleted = 'housing:safehouse-use-completed',
  SafehouseUseDenied = 'housing:safehouse-use-denied',
  HousingReplaySnapshotCreated = 'housing:replay-snapshot-created',
  HousingTelemetry = 'housing:telemetry',
